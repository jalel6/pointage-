...
<div class="body">
        <nav class="side-bar">
            ...
            <ul>
                ...
                <li><a href="demande_conge.php"><i class="fa fa-pencil"></i><span> Demande de Congé</span></a></li>
                <li><a href="jours_feries.php"><i class="fa fa-calendar-plus-o"></i><span>Jours Fériés</span></a></li>
                ...
                <li><a href="lconge.php"><i class="fa-solid fa-calendar-check"></i><span>Liste Congés</span></a></li>
